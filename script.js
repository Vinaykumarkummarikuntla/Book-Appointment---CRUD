...
function saveToServer(event) {
  ...
  axios
    .post(
      "https://crudcrud.com/api/8db1258a49624367a447ff94aeed2815/details/",
...
window.addEventListener("DOMContentLoaded", () => {
  axios
    .get("https://crudcrud.com/api/8db1258a49624367a447ff94aeed2815/details/")
    .then((response) => {
...
function deleteUser(userId) {
  axios
    .delete(
      `https://crudcrud.com/api/8db1258a49624367a447ff94aeed2815/details/${userId}`
    )
    .then((response) => {
      console.log(response);
